...
always_ff @(posedge clk or negedge reset_n) begin
    if (!reset_n) begin
        ...
        if (overcurrent_sync) begin
            if (overcurrent_counter >= 6'd50) begin
        ...
        if (overvoltage_sync) begin
            if (overvoltage_counter >= 6'd50) begin
        ...
        if (undervoltage_sync) begin
            if (undervoltage_counter >= 16'd50000) begin
        ...
        if (overtemperature_sync) begin
            if (overtemperature_counter >= 16'd50000) begin
        ...
        if (fan_failure_sync) begin
            if (fan_failure_counter >= 19'd500000) begin
        ...
        if (sensor_failure_sync) begin
            if (sensor_failure_counter >= 16'd50000) begin
        ...
        if (communication_timeout_sync) begin
            if (communication_timeout_counter >= 21'd1500000) begin
